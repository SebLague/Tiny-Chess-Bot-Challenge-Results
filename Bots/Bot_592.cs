namespace auto_Bot_592;
using ChessChallenge.API;
using System;
using System.Linq;
using System.Numerics;

public class Bot_592 : IChessBot
{
    ...
    public Move Think(Board board, Timer timer)
    {
        ...
        var timeRemaining = timer.MillisecondsRemaining > 40000 ? 5 :
            (timer.MillisecondsRemaining > 15000 ? 4 :
                (timer.MillisecondsRemaining > 5000 ? 3 :
                    (timer.MillisecondsRemaining > 1000 ? 2 : 1)));
        MiniMax(board, timeRemaining, int.MinValue, int.MaxValue, board.IsWhiteToMove, true);
